...
namespace Shared.GameFormats.AnimationMeta.Parsing
{
    ...
    public class MetaDataDatabase : IMetaDataDatabase
    {
        ...
        void CreateDescriptions()
        {
            ...
            _descriptionMap["DOCK_EQPT_LHAND"] = "Dock equipment to the left hand (hand_left bone)";
            _descriptionMap["DOCK_EQPT_RHAND"] = "Dock equipment to the right hand (hand_right bone)";
            _descriptionMap["DOCK_EQPT_LHAND_2"] = "Dock equipment to the second left hand slot";
            _descriptionMap["DOCK_EQPT_RHAND_2"] = "Dock equipment to the second right hand slot";
            _descriptionMap["DOCK_EQPT_LWAIST"] = "Dock equipment to the left waist (root bone)";
            _descriptionMap["DOCK_EQPT_RWAIST"] = "Dock equipment to the right waist (root bone)";
            ...
            _descriptionMap["IMPACT_DIRECTION_POS"] = "Position where directional impact originates";
            ...
            _descriptionMap["SOUND_POSITION"] = "Position and orientation for sound playback";
            _descriptionMap["SYNC_MARKER"] = "Synchronization marker for animation blending";
            _descriptionMap["CANNOT_DISMEMBER"] = "Mark an attack as not causing dismemberment";
            _descriptionMap["ALLOW_LEG_DISMEMBER"] = "Allow leg dismemberment during this animation";
            _descriptionMap["ALLOW_FRONT_LEG_DISMEMBER"] = "Allow front leg dismemberment during this animation";
            _descriptionMap["CAMPAIGN_DISMEMBER"] = "Campaign map dismemberment configuration";
            _descriptionMap["FACEFX"] = "Face FX animation data for facial expressions";
            _descriptionMap["PULL_ROPE"] = "Pull rope interaction marker";
            _descriptionMap["CROP_MARKER"] = "Crop marker for animation trimming";
            _descriptionMap["NOT_HERO_TARGET"] = "Indicates this animation cannot target hero units";
            _descriptionMap["DIE_PERMANENTLY"] = "Unit dies permanently without revival";
            _descriptionMap["DISABLE_ENEMY_COLLISION"] = "Disable collision with enemy units";
            _descriptionMap["MARK_RIGHT_FOOT_FRONT"] = "Mark right foot as the front foot";
            _descriptionMap["NO CHAINING"] = "Prevent animation chaining";
            _descriptionMap["NOT_REGULAR_TARGET"] = "Indicates this animation cannot target regular units";
            _descriptionMap["START_CLIMB"] = "Start a climbing animation";
            _descriptionMap["MATERIAL_FLAG"] = "Set a material flag during the animation";
            _descriptionMap["FREEZE_WEAPON"] = "Freeze weapon in its current state";
            _descriptionMap["USE_BASE_METADATA"] = "Force the use of metadata in the base anim slot during a hardcoded splice. All metadata in the hardcoded splice slot is ignored.";
            ...
            _descriptionMap["PARENT_CONSTRAINT"] = "Constrain to parent bone transform";
        }
